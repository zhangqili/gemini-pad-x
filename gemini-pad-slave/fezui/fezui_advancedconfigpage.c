...
const char* keyconfig_analog_normal_mode_menu_items[] = {"Bindings","Mode","Upper bound","Lower bound","Trigger distance","Schmitt parameter"};

lefl_menu_t keyconfig_analog_rapid_mode_menu;
const char* keyconfig_analog_rapid_mode_menu_items[] = {"Bindings","Mode","Upper bound","Lower bound","Trigger distance","Release distance","Upper deadzone","Lower deadzone"};

lefl_menu_t keyconfig_analog_speed_mode_menu;
const char* keyconfig_analog_speed_mode_menu_items[] = {"Bindings","Mode","Upper bound","Lower bound","Trigger speed","Release speed","Upper deadzone","Lower deadzone"};

lefl_menu_t *current_menu=&keyconfig_digital_mode_menu;

lefl_advanced_key_t* current_config_advanced_key;
...
void keyconfig_digital_mode_menu_cb(void* m)
{
    switch (((lefl_menu_t*)m)->selected_index)
    {
        ...
        case 1:
            mode_switching=true;
            keyconfig_digital_mode_menu.selected_index=1;
            keyconfig_analog_normal_mode_menu.selected_index=1;
            keyconfig_analog_rapid_mode_menu.selected_index=1;
            keyconfig_analog_speed_mode_menu.selected_index=1;
            break;
        default:
            break;
    }
...
void advancedconfigpage_draw(void *page)
{
    ...
    {
        case LEFL_KEY_DIGITAL_MODE:
            u8g2_DrawStr(&(fezui.u8g2), SPERATOR_X-4*7, ROW_HEIGHT*2-2 - (u8g2_int_t)scrollview.ordinate, "Digital");
            break;
        case LEFL_KEY_ANALOG_NORMAL_MODE:
            u8g2_DrawStr(&(fezui.u8g2), SPERATOR_X-4*13, ROW_HEIGHT*2-2 - (u8g2_int_t)scrollview.ordinate, "Analog Normal");
            ...
            u8g2_DrawStr(&(fezui.u8g2), SPERATOR_X-4*6, ROW_HEIGHT*4-2 - (u8g2_int_t)scrollview.ordinate, fezui_buffer);
            ...
            break;
        case LEFL_KEY_ANALOG_RAPID_MODE:
            u8g2_DrawStr(&(fezui.u8g2), SPERATOR_X-4*12, ROW_HEIGHT*2-2 - (u8g2_int_t)scrollview.ordinate, "Analog Rapid");
            ...
            u8g2_DrawStr(&(fezui.u8g2), SPERATOR_X-4*7, ROW_HEIGHT*8-2 - (u8g2_int_t)scrollview.ordinate, fezui_buffer);
            break;
        case LEFL_KEY_ANALOG_SPEED_MODE:
            u8g2_DrawStr(&(fezui.u8g2), SPERATOR_X-4*12, ROW_HEIGHT*2-2 - (u8g2_int_t)scrollview.ordinate, "Analog Speed");
...
lefl_page_t advancedconfigpage={advancedconfigpage_logic,advancedconfigpage_draw,advancedconfigpage_load};
